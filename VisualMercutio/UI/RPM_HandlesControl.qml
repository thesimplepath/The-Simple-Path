    ...
    Rectangle
    {
        ...
        */
        RPM_Handle
        {
            ...
            m_Direction: RPM_Handle.IEDirection.IE_D_Left
        }
        ...
        */
        RPM_Handle
        {
            ...
            // advanced proeprties
            m_Target: ctHandlesControl.m_Target
            m_Direction: RPM_Handle.IEDirection.IE_D_LeftTop
        }
        ...
        */
        RPM_Handle
        {
            ...
            // advanced proeprties
            m_Target: ctHandlesControl.m_Target
            m_Direction: RPM_Handle.IEDirection.IE_D_Top
        }
        ...
        */
        RPM_Handle
        {
            ...
            // advanced proeprties
            m_Target: ctHandlesControl.m_Target
            m_Direction: RPM_Handle.IEDirection.IE_D_RightTop
        }
        ...
        */
        RPM_Handle
        {
            ...
            // advanced proeprties
            m_Target: ctHandlesControl.m_Target
            m_Direction: RPM_Handle.IEDirection.IE_D_Right
        }
        ...
        */
        RPM_Handle
        {
            ...
            // advanced proeprties
            m_Target: ctHandlesControl.m_Target
            m_Direction: RPM_Handle.IEDirection.IE_D_RightBottom
        }
        ...
        */
        RPM_Handle
        {
            ...
            // advanced proeprties
            m_Target: ctHandlesControl.m_Target
            m_Direction: RPM_Handle.IEDirection.IE_D_Bottom
        }
        ...
        */
        RPM_Handle
        {
            ...
            // advanced proeprties
            m_Target: ctHandlesControl.m_Target
            m_Direction: RPM_Handle.IEDirection.IE_D_LeftBottom
        }
    }
